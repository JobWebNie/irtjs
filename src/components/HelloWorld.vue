<template>
  <div class="hello">
    ...
    <div style="width:1200px; height:260px; border-bottom:1px solid #ddd; margin:0 auto">
      <mainindexfour></mainindexfour>
    </div>
    <div style="width:100%; height:600px;" class="lunboIndexThree" :style="{background: 'url('+bottomBg+')'}">
